...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageId = {R.drawable.pun,R.drawable.few,R.drawable.fin};
        String[] name = {"Punjapon","Thanakorn","Aueaoangkun"};
        String[] id = {"623410006-2","623410034-7","623410059-1"};
        String[] number = {"01","02","03"};
        String[] phone = {"062-619-5887","082-532-1271","0642806995"};
        String[] major = {"Computer science","Computer science","Computer science"};
